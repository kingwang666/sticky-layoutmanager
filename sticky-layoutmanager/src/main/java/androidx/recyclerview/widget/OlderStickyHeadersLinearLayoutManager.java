 ...
 */
public class OlderStickyHeadersLinearLayoutManager<T extends RecyclerView.Adapter & StickyHeaders>
    ...
    public OlderStickyHeadersLinearLayoutManager(Context context) {
        super(context);
    }

    public OlderStickyHeadersLinearLayoutManager(
